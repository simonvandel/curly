...
$.uf=R.vw()
$.Xl=J.uP($.Uz)
for(x=0;x<80;++x)for(z=x*5,w=0;w<80;++w){y=$.b7()
v="#"+x*w*100
u=new P.hL(z,w*5)
u.$builtinTypeInfo=[null]
t=[]
t.$builtinTypeInfo=[Q.kW]
y.push(new Q.nK(v,u,!1,2,0,1,t))}z=$.vF
y=J.RE(z)
v=y.gR(z)
if(typeof v!=="number")return v.V()
z=y.gfg(z)
if(typeof z!=="number")return z.V()
z=H.VM(new P.hL(v/2,z/2),[null])
v=H.VM([],[Q.kW])
y=$.vF
u=J.RE(y)
t=u.gR(y)
...
y=H.VM(new P.hL(t/3,y/3),[null])
t=H.VM([],[Q.kW])
$.b7().push(new Q.nK("#FFFFFF",z,!1,5,0,1,v))
$.b7().push(new Q.nK("#FFFF00",y,!1,5,0,1,t))
...
Au:{
"^":"Tp:11;",
call$1:function(a){a.VF($.hb,$.Xl)
if($.uf.ub(37)===!0)a.zk=a.zk+-2
if($.uf.ub(39)===!0)a.zk=a.zk+2}}},1],["dart._internal","dart:_internal",,H,{
"^":"",
...
gDL:function(){return this.it},
gcG:function(){return this.it},
Am:function(a){this.Gv=4
this.it=a},
E6:function(a,b){this.Gv=8
this.it=new P.Ca(a,b)},
au:function(a){var z
if(this.Gv>=4){z=this.Lj
z.toString
P.Tk(z,null,z,new P.da(this,a))}else{a.BQ=this.it
this.it=a}},
...
g:function(a,b){var z=new P.hL(C.CD.g(this.x,b.gx(b)),C.CD.g(this.y,b.gy(b)))
z.$builtinTypeInfo=this.$builtinTypeInfo
return z},
...
return}throw "Unable to print message: " + String(a)}}],["","file:///Users/Simon/Dropbox/Diverse/Programmering/Dart/Curvy/web/keyboard_controller.dart",,R,{
"^":"",
zI:{
"^":"a;ao",
...
Xf:{
"^":"Tp:19;b",
call$1:function(a){this.b.ao.u(0,W.eJ(a).Ar,!0)}}}],["","file:///Users/Simon/Dropbox/Diverse/Programmering/Dart/Curvy/web/player.dart",,Q,{
"^":"",
kW:{
"^":"hL;",
$ashL:function(){return[null]}},
nK:{
"^":"a;ih,jk,qb,jn,zk,Bp,Ii",
...
w=this.Bp
v=this.jk
this.jk=H.VM(new P.hL(y.x+x*w,v.y+Math.sin(z)*w),[null])
y=this.ih
a.fillStyle=y
a.lineJoin="round"
a.strokeStyle=y
...
if($desc instanceof Array)$desc=$desc[1]
mJ.prototype=$desc
function vs(Gv,Lj,it,BQ,OY,As,qV,o4){this.Gv=Gv
this.Lj=Lj
this.it=it
this.BQ=BQ
this.OY=OY
...
if($desc instanceof Array)$desc=$desc[1]
kW.prototype=$desc
function nK(ih,jk,qb,jn,zk,Bp,Ii){this.ih=ih
this.jk=jk
this.qb=qb
this.jn=jn
this.zk=zk
...
if($desc instanceof Array)$desc=$desc[1]
nK.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,QP,IF,Ny,Kh,TK,Y5,Gc,QQ,y4,d7,Um,He,HA,vH,xO,Em,NW,rV,Wy,QF,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,Vb,ST,tb,pA,Mi,HL,In,wP,eP,A6,Og,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,KY,G7,l9,Ql,wL,bP,mX,SN,HD,ni,rR,qj,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,FB,xV,FH,y6,RH,Kn,Z2,w6,BR,r4,aG,J6,Oi,r0,yp,c1,Mq,Nf,Nc,Mx,Q7,yK,Dh,ZJ,mU,eZ,IT,JY,Pq,kx,nV,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,Pe,UM,ZD,vt,cu,BD,vR,j8,Ja,We,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,ET,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Vg,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,Au,a7,i1,xy,MH,SU,Ca,Pf,mJ,vs,da,pV,U7,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,dR,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,FN,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,TH,Fk,RO,Ov,rh,dW,kb,IU,hL,b0,Pg,Ob,GV,zI,FP,Xf,kW,nK]}