...
"^":"",
Iq:[function(){$.qN=document.querySelector("#gameArea")
var z=H.VM(new W.RO(window,C.rl.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(S.zO()),z.Sg),[H.Kp(z,0)]).Zz()
$.Xl=J.uP($.qN)
$.Ho=new Q.nK("#FFFFFF",H.VM(new P.hL(75,75),[null]),2,0)
...
y=$.Ho
x=$.Xl
w=y.zk*0.017453292519943295
z=y.jk
v=Math.cos(w)
u=y.jk
y.jk=H.VM(new P.hL(z.x+v,u.y+Math.sin(w)),[null])
x.beginPath()
z=y.jk
x.arc(z.x,z.y,y.jn,0,6.283185307179586,!1)
x.closePath()
x.lineWidth=0.5
x.fillStyle=y.ih
x.fill()
x=$.Ho
y=x.jk
x.jk=H.VM(new P.hL(y.x+0.1,y.y+0),[null])
C.ol.gm6(window).ml(S.k1())},"call$1","k1",2,0,1],
H3:[function(a){var z,y
z=new W.kb(null,null,null,null,null,a,null)
z.zz(a)
switch(z.Ar){case 37:y=$.Ho
y.zk=y.zk+10
break
case 39:y=$.Ho
y.zk=y.zk+-10
break
default:}},"call$1","zO",2,0,2]},1],["dart._internal","dart:_internal",,H,{
"^":"",
...
this.E6(a,b)
P.HZ(this,z)},function(a){return this.K5(a,null)},"QC","call$2","call$1","giO",2,2,12,13],
$isvs:true,
$isb8:true,
...
return z},
Ou:[function(a,b){return J.de(a,b)},"call$2","iv",4,0,3],
T9:[function(a){return J.le(a)},"call$1","py",2,0,4],
...
return}throw "Unable to print message: " + String(a)}}],["","file:///Users/Simon/Dropbox/Diverse/Programmering/Dart/Curvy/web/player.dart",,Q,{
"^":"",
nK:{
"^":"a;ih,jk,jn,zk"}}],])
...
init.metadata=[{func:"X0",void:true},{func:"QB",void:true,args:[J.P]},{func:"BB",void:true,args:[W.HL]},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"uO",args:[J.O]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Cu",ret:J.O,args:[J.im]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
GV.prototype=$desc
function nK(ih,jk,jn,zk){this.ih=ih
this.jk=jk
this.jn=jn
this.zk=zk}nK.builtin$cls="nK"
if(!"name" in nK)nK.name="nK"
$desc=$collectedClasses.nK
if($desc instanceof Array)$desc=$desc[1]
nK.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,QP,IF,Ny,Kh,TK,Y5,Gc,QQ,y4,d7,Um,He,HA,vH,xO,Em,NW,rV,Wy,QF,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,Vb,ST,tb,pA,Mi,HL,In,wP,eP,A6,Og,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,KY,G7,l9,Ql,wL,bP,mX,SN,HD,ni,rR,qj,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,FB,xV,FH,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,r0,yp,c1,Mq,Nf,Nc,Mx,Q7,yK,Dh,ZJ,mU,eZ,IT,JY,Pq,kx,nV,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,Pe,UM,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,ET,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Vg,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,a7,i1,xy,MH,SU,Ca,Pf,mJ,vs,da,pV,U7,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,v1,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,FN,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,TH,Fk,RO,xC,rh,dW,kb,IU,hL,b0,Pg,Ob,GV,nK]}