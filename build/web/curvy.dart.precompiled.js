...
"%":"ArrayBuffer|Blob|CanvasGradient|CanvasPattern|CanvasRenderingContext|CanvasRenderingContext2D|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList"},
kn:{
"^":"bool/Gv;",
...
VX:{
"^":"Tp:10;c",
call$1:function(a){return this.c(a)}}}],["","file:///Users/Simon/Dropbox/Diverse/Programmering/Dart/Curvy/web/curvy.dart",,S,{
"^":"",
Iq:[function(){var z,y,x
z=document.querySelector("#background")
$.Uz=z
y=J.RE(z)
y.sR(z,500)
y.sfg(z,500)
z=document.querySelector("#players")
$.vF=z
y=J.RE(z)
y.sR(z,500)
y.sfg(z,500)
...
$.h0=new Q.nK("#FFFFFF",H.VM(new P.hL(x/2,z/2),[null]),!1,5,0,-1,2,H.VM([],[Q.kW]))
z=$.vF
x=J.RE(z)
y=x.gR(z)
...
z=x.gfg(z)
if(typeof z!=="number")return z.V()
$.MG=new Q.nK("#FFFF00",H.VM(new P.hL(y/3,z/3),[null]),!1,5,0,-1,2,H.VM([],[Q.kW]))
$.b7().push($.h0)
S.jp(0)},"call$0","eE",0,0,0],
...
x=$.Uz
z=J.RE(x)
y.clearRect(0,0,z.gR(x),z.gfg(x))
x=$.Vt
z=J.xH(a,$.nC)
x.fillStyle="#FFFFFF"
x.font="20pt Helvetica"
if(typeof z!=="number")return H.s(z)
z=""+C.CD.yu(C.CD.UD(1000/z))
y=J.vX(J.DO($.Uz),0.9)
w=J.vX(J.OB($.Uz),0.05)
x.toString
x.fillText(z,y,w)
...
y=z.zk
z.Ve=y
z.zk=y+-5}if($.uf.ub(39)===!0){z=$.h0
y=z.zk
z.Ve=y
z.zk=y+5}if($.uf.ub(65)===!0){z=$.MG
y=z.zk
z.Ve=y
z.zk=y+-5}if($.uf.ub(68)===!0){z=$.MG
y=z.zk
z.Ve=y
z.zk=y+5}z=$.b7()
z.toString
H.bQ(z,new S.Au())
C.ol.gm6(window).ml(S.k1())},"call$1","k1",2,0,1],
Au:{
"^":"Tp:11;",
call$1:function(a){a.VF($.hb,$.Vt)}}},1],["dart._internal","dart:_internal",,H,{
"^":"",
...
if(typeof b==="string"&&b!=="__proto__"){z=this.vv
if(z==null){z=P.T2()
this.vv=z}return this.b3(z,b)}else if(typeof b==="number"&&(b&0x3ffffff)===b){y=this.OX
if(y==null){y=P.T2()
this.OX=y}return this.b3(y,b)}else{x=this.OB
if(x==null){x=P.T2()
this.OB=x}w=this.nm(b)
v=x[w]
...
this.Ar=a.keyCode
this.uT=J.BC(a)},
static:{"^":"UY,nU,qq,cc",eJ:function(a){var z=new W.kb(null,null,null,null,null,a,null)
z.zz(a)
return z}}}}],["dart.dom.svg","dart:svg",,P,{
"^":"",
jw:{
...
g:function(a,b){return H.VM(new P.hL(C.CD.g(this.x,b.gx(b)),C.CD.g(this.y,b.gy(b))),[H.ip(this,"hL",0)])},
W:function(a,b){return H.VM(new P.hL(this.x-J.Rd(b),this.y-b.y),[H.ip(this,"hL",0)])},
...
nl:{
"^":"a;Rn>,fg,R",
$isSg:true}}],["","file:///Users/Simon/Dropbox/Diverse/Programmering/Dart/Curvy/web/keyboard_controller.dart",,R,{
"^":"",
zI:{
"^":"a;ao",
ub:function(a){var z=this.ao.t(0,a)
if(z!=null)return z
else return!1},
HB:function(){var z=H.VM(new W.RO(window,C.Z4.Ph,!1),[null])
H.VM(new W.Ov(0,z.uv,z.Ph,W.VF(new R.FP(this)),z.Sg),[H.Kp(z,0)]).Zz()
z=H.VM(new W.RO(window,C.rl.Ph,!1),[null])
H.VM(new W.Ov(0,z.uv,z.Ph,W.VF(new R.Xf(this)),z.Sg),[H.Kp(z,0)]).Zz()},
static:{vw:function(){var z=new R.zI(P.L5(null,null,null,J.im,J.kn))
z.HB()
return z}}},
FP:{
"^":"Tp:19;a",
call$1:function(a){this.a.ao.u(0,W.eJ(a).Ar,!1)}},
Xf:{
"^":"Tp:19;b",
call$1:function(a){this.b.ao.u(0,W.eJ(a).Ar,!0)}}}],["","file:///Users/Simon/Dropbox/Diverse/Programmering/Dart/Curvy/web/physics_controller.dart",,R,{
"^":"",
Xt:{
"^":"a;UX,eo",
...
if(z)a.ih="#FF0000"
z=a.qk
P.J3(this.a.eo.getImageData(z.x,z.y-y,y,y*2))}}}],["","file:///Users/Simon/Dropbox/Diverse/Programmering/Dart/Curvy/web/player.dart",,Q,{
"^":"",
kW:{
"^":"hL;jn,x,y",
$ashL:function(){return[null]}},
nK:{
"^":"a;ih,qk>,qb,jn,zk,Ve,Bp,Ii",
VF:function(a,b){var z,y,x,w,v
z=this.zk*0.017453292519943295
y=this.qk
x=Math.cos(z)
w=this.Bp
v=this.qk
y=H.VM(new P.hL(y.x+x*w,v.y+Math.sin(z)*w),[null])
this.qk=y
if(this.Ve!==this.zk){y=new Q.kW(null,y.x,y.y)
y.jn=this.jn
this.Ii.push(y)}y=this.ih
a.fillStyle=y
a.lineJoin="round"
a.strokeStyle=y
b.lineJoin="round"
...
a.beginPath()
y=this.qk
a.arc(y.x,y.y,this.jn,0,6.283185307179586,!1)
a.fill()
b.fillStyle="#00FF00"
b.beginPath()
b.moveTo(1,1)
...
J.JO=function(a){return J.RE(a).gqk(a)}
...
I.$lazy($,"players","UX","b7",function(){return[]})
...
init.metadata=[{func:"X0",void:true},{func:"QB",void:true,args:[J.P]},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"uO",args:[J.O]},{func:"B6",args:[Q.nK]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"c0",args:[W.HL]},];$=null
...
function zI(ao){this.ao=ao}zI.builtin$cls="zI"
...
if($desc instanceof Array)$desc=$desc[1]
Xf.prototype=$desc
function Xt(UX,eo){this.UX=UX
this.eo=eo}Xt.builtin$cls="Xt"
if(!"name" in Xt)Xt.name="Xt"
$desc=$collectedClasses.Xt
if($desc instanceof Array)$desc=$desc[1]
Xt.prototype=$desc
function ZA(a,b,c){this.a=a
this.b=b
...
if($desc instanceof Array)$desc=$desc[1]
ZA.prototype=$desc
function kW(jn,x,y){this.jn=jn
this.x=x
this.y=y}kW.builtin$cls="kW"
if(!"name" in kW)kW.name="kW"
$desc=$collectedClasses.kW
if($desc instanceof Array)$desc=$desc[1]
kW.prototype=$desc
function nK(ih,qk,qb,jn,zk,Ve,Bp,Ii){this.ih=ih
this.qk=qk
this.qb=qb
this.jn=jn
this.zk=zk
this.Ve=Ve
this.Bp=Bp
this.Ii=Ii}nK.builtin$cls="nK"
if(!"name" in nK)nK.name="nK"
$desc=$collectedClasses.nK
if($desc instanceof Array)$desc=$desc[1]
nK.prototype=$desc
nK.prototype.gqk=function(receiver){return this.qk}
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,Az,QP,IF,n6,Ny,Kh,TK,Y5,Gc,nx,QQ,fW,y4,d7,Um,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,Nh,cv,Fs,hY,ea,D0,as,dU,Aa,u5,Yu,iG,jP,Ax,xf,Vb,ST,tb,Sg,pA,Mi,HL,In,wP,eP,A6,Og,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,BH,KY,G7,l9,Ql,wL,bP,mX,SN,HD,ni,rR,qj,qW,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,FH,y6,RH,Kn,Z2,w6,BR,r4,aG,J6,Oi,UM,hq,WS,r0,yp,c1,Mq,Nf,Nc,Mx,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,JY,Pq,kx,nV,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,Pe,UD,ZD,vt,cu,BD,vR,j8,Ja,We,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,WZ,ET,df,zU,K8,xj,dE,Zc,dT,N2,LN,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,Fx,O2,aX,cC,RA,IY,JH,jl,Vg,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,tc,lb,tD,hJ,dC,wN,VX,Au,a7,i1,xy,MH,SU,Ca,Pf,mJ,vs,da,pV,U7,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,dR,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,FN,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,Ts,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,zL,ec,TH,Fk,RO,Ov,Pb,rh,W9,dW,kb,IU,hL,b0,Dg,Ob,GV,Pg,fj,Ip,nl,zI,FP,Xf,Xt,ZA,kW,nK]}